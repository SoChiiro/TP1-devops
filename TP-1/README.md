...
```console
git clone https://github.com/efrei2023/practical-exercises.git
```

### 2 - Prepare Jenkins

* Add/Register credentials for git (source code) repository and docker registry.
  * Git : <https://github.com/efrei2023/practical-exercises.git>
    * username: efrei2023
    * password: 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
